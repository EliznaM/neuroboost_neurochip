...
##Group all genes that have pathagenic variants together, depending on the cut-off that we have choosen (cut-off is 20, meaning those variants  above and equal to 20 are pathogenic and below 20are susceptibility variants). Arrange the gene symbols based on their highest value of variant.Draw the bar graph of each variant type.
...
#Separated the data betweeen the g1000 and gnomADg. All Non- African population are being replaced by the word "other". We have filtered the rows that we don't need using the filter function and lastly we grouped by, for the purpose of summarising.
