...
If only 1 allele frequency is non-missing, what proportion of those rows do each population group make up?
...
# TO DO:  make barplot for nr of chromosomes with all variants
