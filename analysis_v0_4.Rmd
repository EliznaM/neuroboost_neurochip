...
p
append(plotlist, p)
append(plotlist_names) <- "nb_number_of_variants_p_chr_allsnp"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_number_of_variants_p_chr_missing_excluded"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_number_of_variants_p_gene_allsnp"
...
p<- genes2 %>% 
  ...
  labs(title = "Number of variants per gene, missing RSIDs excluded", x= "Gene symbol", y= "Number of variants")
p
append(plotlist, p)
append(plotlist_names) <- "nb_number of variants_p_gene_missing_exclude"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_variants_p_consequence"
...
p
append(plotlist, p)
append(plotlist_names) <- "nc_nb_variants_different_impact"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_genes_with_pathogenic_variants"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_genes_with_susceptibility_variants"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_g1000_above$equal20"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_g1000_boxplot_above&equal20"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_g1000_below20"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_g1000_boxplot_below20"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_gnomAD_above&equal20"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_gnomAD_boxplot_above&equal20"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_gnomAD_below20"
...
p
append(plotlist, p)
append(plotlist_names) <- "nb_gnomAD_boxplot_below20"
...
p
append(plotlist, p)
append(plotlist_names) <- "nc_number_of _variants_ per_chromosome"
...
p<- grp_nc2 %>% 
  ggplot(aes(x= reorder(Chromosome, -n), y= n))+
   geom_bar(stat= "identity", color= "black", fill= "blue", width= 0.40) +
  labs(title = "Number of variants per chromosome, missing rsID excluded", x= "Chromosome number ", y= "Number of variants")
p
append(plotlist, p)
append(plotlist_names) <- "nc_nr_vars_p_chr_rsid_excluded"
...
p
append(plotlist, p)
append(plotlist_names) <- "nc_nr_vars_p_gene"
...
p<- plotdta2 %>% 
  ggplot(aes(x= reorder(ANNO_Gene.refGene, -n), y= n))+
   geom_col(stat= "identity", color= "black", fill= "blue", width = 0.40)+
    labs(title = "Number of variants per gene, missing rsID excluded", x=  "Gene symbol", y= "Number of variants")
p
append(plotlist, p)
append(plotlist_names) <- "nc_nr_vars_p_gene_rsid_excluded"
...
p
append(plotlist, p)
append(plotlist_names) <- "nc_variants_p_consequence"
```
...
p
append(plotlist, p)
append(plotlist_names) <- "nc_number_variants_different_impact"
```
...
p
append(plotlist, p)
append(plotlist_names) <- "nc_genes_with_pathogenic_variants"
...
p
append(plotlist, p)
append(plotlist_names) <- "nc_genes_with_susceptibility_variants"
...
# Group by rsID and new column and calculate median for each.???????????????????????????????? FROM VEP OUTPUT, gnomAD DOE NOT HAVE ANY VALUE (EVERYTHING IS NA).
...
summary(plotdta_gnomad$median_AF)
...
p
append(plotlist, p)
append(plotlist_names) <- "nc_allelefrequency_g1000_greater20"
...
p
append(plotlist, p)
append(plotlist_names) <- "nc_allelefrequency_g1000_greater20_boxplot"
...
p<- plotdta %>% 
  ...
  p
append(plotlist, p)
append(plotlist_names) <- "nc_allelfrequency_g1000_below20"
...
p
append(plotlist, p)
append(plotlist_names) <- "nc_allelefrequency_g1000_below20_boxplot"
